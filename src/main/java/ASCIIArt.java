...
public class ASCIIArt {
    ...
    public static void generate(String string) throws Exception {
        ASCIIArt artGen = new ASCIIArt();

        System.out.println();
        artGen.printTextArt(string, ASCIIArt.ART_SIZE_MEDIUM);
        System.out.println();
    }


    private void printTextArt(String string, int textHeight, ASCIIArtFont fontType, String artSymbol) throws Exception {
        String fontName = fontType.getValue();
        int imageWidth = findImageWidth(textHeight, string, fontName);
        ...
        graphics.drawString(string, 0, getBaselinePosition(g, font));
    ...
    private void printTextArt(String string, int textHeight) throws Exception {
        printTextArt(string, textHeight, ASCIIArtFont.ART_FONT_DIALOG, DEFAULT_ART_SYMBOL);
    }

    private int findImageWidth(int textHeight, String string, String fontName) {
